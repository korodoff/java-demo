...
// function res (){
//     let pp = "yes man"//local socpe variable
//     console.log(pp)//o/p 
// }
...
// let sew = arra.filter(x => x>3);// it dont push element less than 3
// console.log(sew);// here it return element greater than 3
